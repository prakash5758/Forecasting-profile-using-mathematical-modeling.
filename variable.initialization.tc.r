...
# Jonathan Henderson; Last modified: 02 JAN 2022 10:30 PM MST
...
tcInitialRateMin <- 0.8                              # Minimum initial rate % from peak
tcInitialRateMax <- 1.2                              # Maximum initial rate % from peak
...
tcInitialDeclineMax <- 0.99                          # Maximum initial decline % secant eff
...
tcCurveName <- "SMART TC"                            # Type curve name
tcPrimaryPhase <- "OIL"                              # Primary phase - DON'T CHANGE THIS IS CALC'D
tcProbability <- "Avg"                               # Probability for type curve override
tcDeclineMethod <- "type"                            # Controls whether batch and type curve or type curve
tcBatchName <- "SMART TC"                            # Batch process name
...
tcPeakMonth <- 0.80                                  # Peak Month detection - as % of production it can skip
...
tcNormalizeValue <- 10000                            # Normalization value for type curve                  
