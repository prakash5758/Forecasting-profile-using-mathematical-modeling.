...
library(ggplot2)
print('r succesfull')
summary_input <- read.csv("./Gas_Example_bounds_qi_summary.csv")
print('summary file imported succesfully')
# print(names(summary_input))
summary_in <- summary_input[c("api",
  "operator",
  "interval",
  "lateral_length_ft",
...
# print('sumary file took')
forecasts_input_name <- "Gas_Example_bounds_qi_forecast_2wells 1.csv"
...
# print(names(forecasts_input))
forecasts_in<- forecasts_input[c("api",
  "date",
  "days_on",
  "producing_month",
  "oil",
...
# print(paste(nrow(forecasts_in)))
# print("forcast_in_took")
forecasts_input <- merge(forecasts_in, summary_in, by = 'api')
